...
export function useAppNavigation() {
  ...
  const goToParentLanguage = useCallback(() => {
    router.push(ROUTES.parent.language as any);
  }, [router]);
  ...
  const goToSchoolLanguage = useCallback(() => {
    router.push(ROUTES.school.language as any);
  }, [router]);

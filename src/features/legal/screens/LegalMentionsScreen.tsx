  ...
  return (
    ...
    >
      ...
      <Section title="1. Présentation du site">
        <Body>
          {`En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, voici les informations relatives aux intervenants du site https://securi-click.com/ :\n\nResponsable de publication : Marine RAULT\nWebmaster : Gabriel BOUFFANET\nHébergeur : o2Switch — https://www.o2switch.fr/\nNom de domaine : OVH\n\nSECURI'CLICK\nMarine RAULT\n1 Rue Louis Jourdan\n83000 Toulon`}
        </Body>
      </Section>

      <Section title="2. Conditions générales d'utilisation">
        <Body>
          {`L'utilisation du site https://securi-click.com/ implique l'acceptation pleine et entière des présentes conditions d'utilisation.\n\nCes conditions sont susceptibles d'être modifiées à tout moment. Le site est normalement accessible à tout moment, sauf interruption pour maintenance technique décidée par Marine RAULT.`}
        </Body>
      </Section>

      <Section title="3. Description des services fournis">
        <Body>
          {`Le site https://securi-click.com/ a pour objet de fournir une information concernant l'ensemble des activités exercées par Marine RAULT.\n\nMarine RAULT s'efforce de fournir des informations aussi précises que possible. Toutefois, elle ne pourra être tenue responsable des omissions, inexactitudes et carences dans la mise à jour.`}
        </Body>
      </Section>
      ...
      <Section title="5. Propriété intellectuelle et reproduction">
        <Body>
          {`Le site constitue une œuvre dont Marine RAULT est l'auteur au sens des articles L111.1 et suivants du Code de la propriété intellectuelle. Marine RAULT est propriétaire des droits de propriété intellectuelle ou détient les droits d'usage sur tous les éléments accessibles sur le site.\n\nToute reproduction ou représentation sans accord préalable est interdite et constitue un acte de contrefaçon.`}
        </Body>
      </Section>

      <Section title="6. Limitations de responsabilité">
        <Body>
          {`Marine RAULT ne pourra être tenue responsable des dommages directs et indirects causés au matériel de l'utilisateur lors de l'accès au site.\n\nDes espaces interactifs sont à disposition des utilisateurs. Marine RAULT se réserve le droit de supprimer tout contenu qui contreviendrait à la législation applicable en France.`}
        </Body>
      </Section>

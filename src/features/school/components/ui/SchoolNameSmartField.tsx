    ...
    >
      ...
      >
        <Ionicons
          ...
          size={12}
          color={isStrong ? theme.green : theme.primary}
        />
        <Text
          style={{
            fontSize: 11,
        ...
        {school.confidence >= 95 && (
          <Ionicons name="shield-checkmark" size={11} color={theme.green} />
        )}
        {school.verified && (
          <View
            style={{
      ...
      >
        ...
        >
          <Ionicons
            ...
            size={16}
            color={isStrong ? theme.green : theme.accent}
          />
        </View>
        <View style={{ flex: 1 }}>
          <Text
      ...
      >
        ...
        <TouchableOpacity
          onPress={onApply}
          style={{ flex: 2, paddingVertical: 11, alignItems: 'center' }}
        >
